...
ArtNem_AIZIntroSprites:		binclude "Levels/AIZ/Nemesis Art/Intro Waves.bin"
	even
ArtNem_SurfboardSplash:		binclude "Levels/AIZ/Nemesis Art/Surfboard Splash.bin"
	even
ArtNem_Surfboard:		binclude "Levels/AIZ/Nemesis Art/Surfboard.bin"
	even
...
MapUnc_SaveScreenStatic4:	binclude "General/Save Menu/Uncompressed Map/Static 4.bin"
	even
ArtKos_SaveScreenMisc:		binclude "General/Save Menu/Kosinski Art/Misc BK.bin"
	even
