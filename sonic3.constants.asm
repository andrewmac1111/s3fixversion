...
Player_mode			ds.w 1			; 0 = Sonic and Tails, 1 = Sonic alone, 2 = Tails alone, 3 = Knuckles alone, 4 = Knuckles and Tails Or Bluckles In BlueKnux Version
...
sfx_ElectricShieldAlt		ds.b 1		; $40
